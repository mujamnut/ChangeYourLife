    ...
    fun toDomain(response: ChatWithActionsResponseDto): ChatActionResult {
        ...
        return ChatActionResult(
            ...
            diagnostics = AiDiagnostics(
                ...
                pdfFileCount = response.diagnostics.pdfFileCount,
                pdfPageCount = response.diagnostics.pdfPageCount,
                pdfExtractionStatus = response.diagnostics.pdfExtractionStatus,
